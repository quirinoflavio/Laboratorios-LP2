...
public class Cenario {
	 ...
	 */
	public void alteraSeguroValor(int indiceAposta, int valor) {
		getAposta(indiceAposta).alteraSeguroValor(valor);
	}
	 ...
	 */
	public void alteraSeguroTaxa(int indiceAposta, double taxa) {
		getAposta(indiceAposta).alteraSeguroTaxa(taxa);
	}
