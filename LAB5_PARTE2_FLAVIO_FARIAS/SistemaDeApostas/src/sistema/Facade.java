...
public class Facade {
	...
	public int cadastrarApostaSeguraValor(int cenario, String apostador, int valor, String previsao, int valorSeguro,
			int custo) {
		controle.cadastrarApostaSeguraValor(cenario, apostador, valor, previsao, valorSeguro, custo);
		return cenario;
	}

	public int cadastrarApostaSeguraTaxa(int cenario, String apostador, int valor, String previsao, double taxa,
			int custo) {
		controle.cadastrarApostaSeguraTaxa(cenario, apostador, valor, previsao, taxa, custo);
		return cenario;
	}

	public int alterarSeguroValor(int cenario, int apostaAssegurada, int valor) {
		controle.alteraSeguroValor(cenario, apostaAssegurada, valor);
		return cenario;
	}

	public int alterarSeguroTaxa(int cenario, int apostaAssegurada, double taxa) {
		controle.alteraSeguroTaxa(cenario, apostaAssegurada, taxa);
		return cenario;
	}

	public int sad() {
		return controle.getCenario(6).getQuantidadeDeApostas();
	}
